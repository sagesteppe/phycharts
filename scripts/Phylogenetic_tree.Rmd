...
node_dist <- data.frame(
  ...
  order = c(
    ...
    rep('Saxifragaceae', each = length(c(305:311, 61:69))),
...
color_palette_map <- data.frame(
  order =  c("Asterales", "Alismatales",  "Asparagales", "Apiales", "Boraginales", 
             ...
             "Ericales", "Fabales",  "Gentianales", 'Geraniales', "Lamiales", "Liliales", 
             "Malpighiales", "Malvales", "Myrtales", "Ranunculales", "Rosales", 
             "Sapindales", 'Saxifragaceae', 'Solanales', 'Zingiberales'),
  color = c(sample(colors(), size =  25))
)
